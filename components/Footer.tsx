  ...
  return (
    <footer className="bg-transparent py-10 px-6 border-t border-stone-100 dark:border-stone-800/50">
      <div className="flex flex-col items-center justify-center gap-8 text-center">
        <a
          href={addressConfig.mapsUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="text-stone-light/60 dark:text-stone-500 text-xs font-medium hover:text-primary dark:hover:text-primary transition-colors duration-300 flex items-center gap-1.5"
        >
        ...
        <div className="flex flex-col items-center gap-3">
          <div className="flex gap-10 items-center">
            ...
            <a
              ...
              className="text-stone-text dark:text-white hover:text-primary transition-colors duration-300"
            >
          ...
          <p className="text-stone-light/50 dark:text-stone-500 text-[10px] font-bold uppercase tracking-[0.2em]">Connect with us</p>
        </div>
